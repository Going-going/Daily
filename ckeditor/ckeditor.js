			...
			removeStyle: function(a) {
				...
				if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");
					...
					for (var b = [], d = 0; d < c.length; d++)
						if (e)
							for (var v =
									0; v < e.length; v++) b.push([a, c[d], e[v]].join("-"));
	...
	(function() {
		function a(a, b) {
			...
			this.current ? e = this.current[C](!1, r, g) : (a ? e.type == CKEDITOR.NODE_ELEMENT &&
				(e = 0 < y ? e.getChild(y - 1) : !1 === g(e, !0) ? null : e.getPreviousSourceNode(!0, r, g)) : (e = d, e.type == CKEDITOR.NODE_ELEMENT && ((e = e.getChild(f)) || (e = !1 === g(d, !0) ? null : d.getNextSourceNode(!0, r, g)))), e && !1 === g(e) && (e = null));
			for (; e && !this._.end;) {
				this.current = e;
		...
		CKEDITOR.dom.walker.editable = function(a) {
			return function(b) {
				b =
					q(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(y) && e(b)) ? !0 : !1;
				return !!(a ^ b)
			}
		};
			...
			enlarge: function(a, b) {
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						E.type == CKEDITOR.NODE_TEXT ? (t && (E = !CKEDITOR.tools.trim(E.substring(0, t)).length && E, L = !!E), E && ((r = E.getPrevious()) || (n = E.getParent()))) : (t && (r = E.getChild(t - 1) || E.getLast()),
							r || (n = E));
						for (n = c(n); n || r;) {
							if (n && !r) {
								!C && n.equals(m) && (C = !0);
						...
						n = r = null;
						C = L = !1;
						E.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(E.substring(t)).length ? L = !0 : (L = !E.getLength(), t == E.getLength() ? (r = E.getNext()) ||
							(n = E.getParent()) : g(E, t) && (n = E.getParent())) : (r = E.getChild(t)) || (n = E);
						for (; n || r;) {
							if (n && !r) {
								!C && n.equals(m) && (C = !0);
								if (f ? n.isBlockBoundary() : !h.contains(n)) break;
				...
				if (!this.disabled && a) {
					...
					for (e = 0; e < a.length; ++e) {
						...
						for (n = 0; n < b.length; ++n) l = b[n], "string" == typeof l ? (l = l.split(/\s*:\s*/), g = l[0], m = null, t = l[1]) : (g = l.check, m = l.left, t = l.right), f || (f = l, f = f.element ? f.element : g ? g.match(/^([a-z0-9]+)/i)[0] :
							f.left.getDefinition().element), m instanceof CKEDITOR.style && (m = E(m)), c.push({
							check: g == f ? null : g,
							left: m,
					...
					if (a(f)) m.push(f);
						...
						if ("br" == e) M.push(f);
							...
							for (; !(k = (g = w.name) ? CKEDITOR.dtd[g] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || w.isUnknown || k[e]);)
								...
								!x(e, g)) F.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
		...
		a.prototype = {
			...
			exec: function(a, c) {
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
					...
					p, q, e, y;
				for (y = 0; y < h; y++)
					if (d && (p = c.type, q = c.name), e = k[y], !(a.nonEditable && !e.options.applyToAll ||
	...
	(function() {
		...
		u = function() {
			...
			function b(c, d) {
				...
				e = d.range.startPath();
				for (var z = D[z.getName()], h = 0, I = c.getChildren(), m = I.count(), q = -1, p = -1, P = 0, E = e.contains(D.$list); h < m; ++h) e = I.getItem(h), a(e) ? (g =
					e.getName(), E && g in CKEDITOR.dtd.$list ? k = k.concat(b(e, d)) : (t = !!z[g], "br" != g || !e.data("cke-eol") || h && h != m - 1 || (P = (f = h ? k[h - 1].node : I.getItem(h + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && D.$block[f.getName()]), -1 != q || t || (q = h), t || (p = h), k.push({
						isElement: 1,
						isLineBreak: P,
			...
			function g(b, c, d, e) {
				...
				(t = (new CKEDITOR.dom.walker(f)).next()) && a(t) && z[t.getName()] && (k = t.getPrevious()) && a(k) && !k.getParent().equals(b.startContainer) &&
			...
			return function(z, l, K, B) {
				...
				if (!B.checkReadOnly()) {
					...
					B = z.mergeCandidates;
					var q, p;
					"text" == z.type && l.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (q = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e",
					...
					if (q = K) {
						...
						if ((u = q.startPath().block) && (1 !=
								u.getChildCount() || !u.getBogus())) a: {
							var y;
					...
					if (q) {
						...
						var J = z.endPath.elements[0],
							W, G = J.getPosition(l),
							v = !!J.getCommonAncestor(l) && G != CKEDITOR.POSITION_IDENTICAL && !(G & CKEDITOR.POSITION_CONTAINS +
						...
						for (t(l, y); B < l.length; B++) {
							...
							if (x) K = 0 < B;
								...
								x = y.startPath();
								!G.isBlock && k(z.editor, x.block, x.blockLimit) && (T = h(z.editor)) && (T = q.createElement(T),
									T.appendBogus(), y.insertNode(T), CKEDITOR.env.needsBrFiller && (w = T.getBogus()) && w.remove(), y.moveToPosition(T, CKEDITOR.POSITION_BEFORE_END));
						...
						w && (K = !0, x = l[0].node, y.setStartAt(x, CKEDITOR.POSITION_BEFORE_START),
							y.setEndAt(x, CKEDITOR.POSITION_AFTER_END));
						z.dontMoveCaret = K;
	...
	(function() {
		...
		CKEDITOR.on("instanceCreated", function(a) {
			...
			c.on("contentDom", function() {
				...
				if (CKEDITOR.env.ie || D) m ? h.attachListener(h, "beforedeactivate",
				...
				if (CKEDITOR.env.ie && !D) {
					...
					h.attachListener(h, "mouseup", function(a) {
						2 == a.data.$.button &&
							v && (c.document.$.documentElement.scrollLeft = v.x, c.document.$.documentElement.scrollTop = v.y);
						v = null
					});
							...
							if (m) {
								...
								for (G = 0; G < a.length; G++) {
									...
									b.collapsed && CKEDITOR.env.webkit && q(b) && (l = e(this.root), b.insertNode(l), (A = l.getNext()) && !l.getPrevious() && A.type == CKEDITOR.NODE_ELEMENT && "br" ==
										A.getName() ? (y(this.root), b.moveToPosition(A, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(l, CKEDITOR.POSITION_AFTER_END));
	...
	(function() {
						...
						for (var m = M(this, e), x = m.hasAttributes(), w = y.getCommonAncestor(), u = {}, D = {}, E = {}, H = {}, U, R, aa; m && w;) {
							if (w.getName() == g) {
								for (U in h.attributes) !H[U] &&
									(aa = w.getAttribute(R)) && (m.getAttribute(U) == aa ? D[U] = 1 : H[U] = 1);
		...
		function p(a) {
			...
			for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) &&
				(d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), q(d, e)) : x.call(this, d));
			a.moveToBookmark(b)
		}
	...
	*/
	...
	(function() {
				...
				if (a) {
					...
					if (f)
						for ((d = a.getSelectedElement()) && !d.isReadOnly() &&
							b(this._contexts, c, d), d = 0; d < f.elements.length; d++) {
							var g = f.elements[d];
		...
		CKEDITOR.plugins.add("balloontoolbar", {
			...
			init: function(a) {
				a.balloonToolbars = new CKEDITOR.plugins.balloontoolbar.contextManager(a);
				l || (l = !0, CKEDITOR.ui.balloonToolbarView.prototype = CKEDITOR.tools.extend({}, CKEDITOR.ui.balloonPanel.prototype), CKEDITOR.ui.balloonToolbarView.prototype.build =
					function() {
						...
						if (!this.rect.visible) {
							...
							this._listeners.push(this.editor.on("resize",
								a, this));
						...
						this._detachListeners()
					}, CKEDITOR.ui.balloonToolbarView.prototype.renderItems =
					function(a) {
						var c = [],
						...
						CKEDITOR.tools.array.forEach(this.parts.content.find("a").toArray(),
							function(a) {
				...
				b = {
					...
					init: function() {
						...
						c && !c.$.complete && b(c, function() {
							...
							b.rect.visible && b.attach(b._pointedElement, {
								focusElement: !1
							})
						});
						c = this.element.data("cke-upload-id");
						"undefined" !==
						typeof c && (this.setData("uploadId", c), this.element.data("cke-upload-id", !1));
					...
					_loadDefaultStyle: function() {
						...
						}!b && e && a.getCommand("easyimage" + g(e)) && this.applyStyle(a.getCommand("easyimage" +
							g(e)).style)
					}
				};
			e && (b.requiredContent += "(!" + e + ")", b.allowedContent.figure.classes = "!" + e + "," + b.allowedContent.figure.classes);
