...
(function ($) {
    ...
    function createDom(_this, cyProps) {
        ...
        var outHtml =
            _this.html([
                ...
                '<div lay-value="dd-page" class="dd-bar dd-page dontHide">',
        ...
        layui.use(['form', 'laypage'], function () {
            ...
            laypage.render({
                ...
                , jump: function (obj, first) {
                    ...
                    form.render();
                    // $("#" + obj.elem).parents(".select-page").addClass('active').find('.layui-form-select dl').css('display', 'block');
                }
            });
        });
    }
    ...
    $(document).on("click", function (e) {
        ...
        // if ($(e.target).parents('div').hasClass('layui-laypage')) { 
        //     console.log($(e.target).parents())
        //     $('layui-form-selected').addClass("active")
            
        // } else {
        //     // $("[cyType='selectPageTool'] .select-page").removeClass("layui-form-selected");
        // }
        // e.stopPropagation();
        // e.preventDefault();
    });
